...
type Viewswtichstatus struct {
	beego.Controller
}

func (c *Viewswtichstatus) Get() {
	log.Println(beego.AppConfig.String("loglevel"), "Info", "View Switch Page Start")
	pip := c.Ctx.Input.IP()
	...
	defer func() {
		...
		if err != nil {
			...
			c.TplName = "switchmanagement/viewswtichstatus/viewswtichstatus.html"
			log.Println(beego.AppConfig.String("loglevel"), "Info", "View Switch Page Fail")
		} else {
			c.Data["DisplayMessage"] = ""
			c.TplName = "switchmanagement/viewswtichstatus/viewswtichstatus.html"

			log.Println(beego.AppConfig.String("loglevel"), "Info", "View Switch Page Success")
		}
		return
	}()
	...
	auth, err := utils.IsAuthorized(sess.Get("menujson").(string), "ViewSwitchStatus")
	...
	if sess.Get("role") == "ADMIN" && sess.Get("language") == "English" {
		...
		c.Data["ViewSwtichStatus"] = beego.AppConfig.String("ENGLISH_VIEW_SWTICH_STATUS")
		c.Data["SwtichStatus"] = beego.AppConfig.String("ENGLISH_SWTICH_STATUS")
		c.Data["Modify"] = beego.AppConfig.String("ENGLISH_MODIFY_BUTTON")
		...
		c.Data["ViewSwtichStatus"] = beego.AppConfig.String("FRENCH_VIEW_SWTICH_STATUS")
		c.Data["SwtichStatus"] = beego.AppConfig.String("FRENCH_SWTICH_STATUS")
		c.Data["Modify"] = beego.AppConfig.String("FRENCH_MODIFY_BUTTON")
