...
func (c *ViewRole) Get() {
	...
	log.Println(beego.AppConfig.String("loglevel"), "Info", "View Role Page Start")
	pip := c.Ctx.Input.IP()
	...
	defer func() {
		...
		if err != nil {
			...
			c.TplName = "role/viewRole/viewRole.html"
			log.Println(beego.AppConfig.String("loglevel"), "Info", "View Role Page Fail")
		} else {
			c.Data["DisplayMessage"] = ""
			c.TplName = "role/viewRole/viewRole.html"
			log.Println(beego.AppConfig.String("loglevel"), "Info", "View Role Page Success")
		}
		return
	}()
