...
type UpdateRefund struct {
	beego.Controller
}

func (c *UpdateRefund) Get() {
	...
	defer func() {
		...
		if err != nil {
			...
			c.TplName = "processing/refundProcessing/updateRefund/updateRefund.html"
